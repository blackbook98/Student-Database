...
public class Controller {
	...
	Button load,Save;
	 ...
	 ArrayList<String> name = new ArrayList<String>();
		...
		String output,tt,file, cnamestr,ccodestr;
	...
	public void Save(ActionEvent e)throws IOException
	{
		...
		ccodestr= ccode.getText().toString();
		
		cnamestr = cnamestr.toUpperCase();
		ccodestr = ccodestr.toUpperCase();
		...
		{  
	        ...
	        sheet_at.createRow(0).createCell(0).setCellValue("USN");
	        sheet_at.getRow(0).createCell(1).setCellValue("Name");
	        sheet_at.getRow(0).createCell(2).setCellValue("Classes");
	        sheet_at.getRow(0).createCell(3).setCellValue("Percentage");
	        
	        System.out.println(usn.size()+"dsadad"+name1.size());
	        
		    for(int i=1;i<usn.size();i++)
		    {
		    	sheet_at.createRow(i).createCell(0).setCellValue(usn.get(i-1));
		    	sheet_at.getRow(i).createCell(1).setCellValue(name1.get(i-1));
	        ...
	        sheet_mk.getRow(0).createCell(2).setCellValue("Marks[50]");
	        sheet_mk.getRow(0).createCell(3).setCellValue("Marks[10]");
